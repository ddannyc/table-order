...
## mock-spec.html 点餐页对齐（2026-06-28 第三轮）
- [x] **M1** # 板块标题加蓝色横线填充整行（设计签名/蓝点缀） + menu-spec-align.test.js
- [x] **M2** 门店栏透明底 + 粉圆白针 + 店名 900 + 点餐方式药丸浅粉底深粉字
- [x] **M3** 价格标 800 + 黄立体底影 #E0B900；菜名 900；加减器粉边圆按钮
- [x] **M4** 品牌标题 60rpx + 深粉立体投影；购物车条改浮动粉药丸 + 黄车标 + 去结算 900
- 设备核对 element_getStyles 全部确认（蓝线/mode/cartbar/step/price/cart-icon/brand-shadow）；全量 221 绿。
- 未做(需资源/数据)：彩色食物缩略图(OSS 真图) · 优惠圈 9.9(promo 数据) · 庆科黄油体(体积大,系统900替代)
